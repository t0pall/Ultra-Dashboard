...
export const AccountSettings = ({ opened, setOpened, userId }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        <Text strong>{t("buttons.accountSettings")}</Text>
        <Button
          type="text"
          icon={<CloseOutlined />}
          onClick={() => closeModal()}
      ...
      >
        <Card>
          <Form {...formProps} layout="vertical">
            ...
            />
            <Form.Item label={t("account.Name")} name="name">
              <Input placeholder={t("account.name")} />
            </Form.Item>
            <Form.Item label={t("account.Email")} name="email">
              <Input placeholder={t("account.email")} />
            </Form.Item>
            <Form.Item label={t("account.JobTitle")} name="jobTitle">
              <Input placeholder={t("account.jobTitle")} />
            </Form.Item>
            <Form.Item label={t("account.Phone")} name="phone">
